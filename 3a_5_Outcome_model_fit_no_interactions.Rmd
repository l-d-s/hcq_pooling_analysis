...
output: 
  html_document:
    keep_md: false
params:
  fit_name: "main_fit_no_interactions"
  outcome_min: 28
  outcome_max: 35
...
here::i_am(file.path("hcq_pooling_analysis", "3a_5_Outcome_model_fit_no_interactions.Rmd"))
...
brm_fit <-
  brm_multiple(
      ...
      data = mice_df_list,
      cores = ncores,
      control = list(adapt_delta = 0.9999), # helps avoid divergent transitions 
      iter = 3000,
      thin = 3,
      backend = 'cmdstanr',
      seed = 20200524
